// Research Home - Shows only Research type projects
document.addEventListener('DOMContentLoaded', function() {
    console.log('Research Home loaded - filtering Research projects');
    initializeSpecificCarousel('research');
});
...
async function initializeSpecificCarousel(type) {
    ...
    try {
        ...
        switch (type.toLowerCase()) {
            case 'research':
                result = await ProjectAPI.getResearchProjects();
                break;
        }
