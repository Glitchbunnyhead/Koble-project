// Extension Home - Shows only Extension type projects
document.addEventListener('DOMContentLoaded', function() {
    console.log('Extension Home loaded - filtering Extension projects');
    initializeSpecificCarousel('extension');
});
...
async function initializeSpecificCarousel(type) {
    ...
    try {
        ...
        switch (type.toLowerCase()) {
            case 'extension':
                result = await ProjectAPI.getExtensionProjects();
                break;
        }
